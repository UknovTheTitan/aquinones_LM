...
int main()
{
    ...
    if (ventas >= 1500)
    {
        ...
        cout << "El vendedor vendio: " << ventas << " y recibira un bono de 125, dando un total de " << bono << endl;
    }
    ...
    {
        double total = porcentaje(ventas);
        cout << "El vendedor vendio: " << ventas << " y no recibira bono, dando un total de " << sueldo + total << endl;
    }
